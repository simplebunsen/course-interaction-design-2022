...
function setup() {
  ...
  let blueColors = [color("#845EC2"), color("#D65DB1"), color("#FF6F91"), color("#FF9671"), color("#FFC75F"), color("#F9F871")];
  let redColors = [color("#000000"), color("#2A272A"), color("#4B4A54"), color("#677381"), color("#82A0AA"), color("#A3CFCD")];
